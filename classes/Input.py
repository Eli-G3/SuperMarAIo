...
class Input:
    ...
    def isRightArrowPressed(self, events):
        return self.checkMouse(events, pygame.K_RIGHT)

    def isLeftArrowPressed(self, events):
        return self.checkMouse(events, pygame.K_LEFT)

    def isUpArrowPressed(self, events):
        return self.checkMouse(events, pygame.K_UP)

    def isDownArrowPressed(self, events):
        return self.checkKeyPress(events, pygame.K_DOWN)

    def checkKeyPress(self, events, key):
        for e in events:
